...
# Create a simple PDF
doc = fitz.open()
page = doc.new_page(width=72*8.5, height=72*11)  # Letter size
page.insert_text((100, 100), 'SHEET 1 REV A', fontsize=12)
pdf_bytes = doc.tobytes()
doc.close()

# Create another PDF with a change
doc = fitz.open()
page = doc.new_page(width=72*8.5, height=72*11)
page.insert_text((100, 100), 'SHEET 1 REV B', fontsize=12)
